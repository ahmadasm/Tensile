...
namespace DashboardAsync.Models
{
    ...
    public class AsyncClient
    {
        ...
        private IParser<IControlData> _parser;
        ...
        public AsyncClient(IMessageHandler messageHandler) 
        {
            this._messageHandler = messageHandler;
        }

        public AsyncClient(string hostIp, int portNumber,IMessageHandler messageHandler)
        {
            this._hostIp = hostIp;
            ...
            try
            {
                ...
                if (bytesRead > 0)
                {
                    ...
                    if ((content.IndexOf("\r") > -1) || (content.IndexOf("\n") > -1) || (content.IndexOf("\r\n") > -1))
                    {
                        ...
                        //_messageHandler.HandleMessage(content);
                        //var data = _parser.Pars(content);
